...
const API_BASE_URL = process.env.NEXT_PUBLIC_BACKEND_URL || process.env.NEXT_PUBLIC_SERVER_URL || '';
console.log('API_BASE_URL configured as:', API_BASE_URL || 'local API routes');
